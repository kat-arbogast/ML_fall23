...
itemFrequencyPlot(or_cause_comments_transactions, topN=20, type="absolute")
```

```{r}
## Plot of which items are most frequent
itemFrequencyPlot(or_specific_cause_transactions, topN=20, type="absolute")
```

```{r}
## Plot of which items are most frequent
itemFrequencyPlot(news_headlines_transactions, topN=25, type="absolute")
```
