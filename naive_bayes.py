...
def main():
    ...
    print("\n\n ---------- Naive Bayes ---------- \n")
    fires_monthly_dict_pred = multinomial_naive_bayes(fires_monthly_sample_dict, us_fires_burn_monthly_filename)
    fires_season_dict_pred = multinomial_naive_bayes(fires_season_sample_dict, f"{us_fires_burn_monthly_filename}_season")
    
    news_dict_pred = multinomial_naive_bayes(news_sample_dict, news_headlines_vector_filename)
    news2_dict_pred = multinomial_naive_bayes(news2_sample_dict, f"{news_headlines_vector_filename}_2")
    news_dict_select_pred = multinomial_naive_bayes(news_sample_dict_selected, f"{news_headlines_vector_filename}_wildfires_weather")
    news_dict_select2_pred= multinomial_naive_bayes(news_sample_dict2, f"{news_headlines_vector_filename}_burn_weather")
    
    or_dict_cause_pred = multinomial_naive_bayes(or_cause_sample_dict, or_weather_wildfires_comments_vector_filename)
    or_dict_specific_pred = multinomial_naive_bayes(or_specific_sample_dict, or_weather_wildfires_specific_vector_filename)
    or_dict_pred = multinomial_naive_bayes(or_sample_dict, or_weather_wildfires_filename)
    or_dict_balanced_pred = multinomial_naive_bayes(or_sample_balanced_dict, f"{or_weather_wildfires_filename}_balanced")
